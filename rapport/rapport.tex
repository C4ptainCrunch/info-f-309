...
Commande : \texttt{systemctl start/stop/status nginx.service}
Fichiers de Configuration: \ref{subs:deb-pg-hba} et 
...
Commande : \texttt{systemctl start/stop/status django.service} \ref{subs:deb-django-service}
...
\begin{appendices}
  ...
  \lstinputlisting[basicstyle=\ttfamily]{annexe/deb-webview-local-settings.py}
  ...
  /subsubsection{/etc/postgresql/9.4/main/pg_hba.conf}
  ...
  \lstinputlisting[basicstyle=\ttfamily]{annexe/etc-rcd-celery}

  \subsubsection{/home/celery/info-f-309/webview/webview/local\_settings.py}
  \label{subs:webview-local-settings}
  \lstinputlisting[basicstyle=\ttfamily]{annexe/webview-local-settings.py}
\end{appendices}
