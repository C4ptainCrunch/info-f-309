...
Le NFS permet de synchroniser l'horloge de la machine avec un serveur de temps.
Voici sa méthode de configuration:
\begin{enumerate}
  \item ajouter ``nfs_client_enable="YES"'' dans \texttt{/etc/rc.conf}
