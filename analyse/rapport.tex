...
Nous n'utiliserons pas Samba puisqu'il a été développé principalement pour Windows, ça coule de source. De plus, il n'est pas suffisamment sécurisé pour notre utilisation\footnote{\url{http://goo.gl/avsDdH}}.
