...
%TODO : antivirus
Après la compilation, nous allons analyser le pdf généré avec un antivirus pour éviter de contaminer le pc de nos clients. Pour se faire, nous allons utiliser ClamAV\footnote{\url{http://www.clamav.net/}} un AntiVirus open source.
