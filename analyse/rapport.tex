...
Nous n'allons pas non plus utiliser Amazon Sii3 puisque celui-ci n'est pas gratuit et ne rentre pas dans le budget de notre startup. De plus stocker nos fichiers sur un serveur Amazon créerait de la latence pour nos utilisateurs lors du téléchargement de ceux-ci.
